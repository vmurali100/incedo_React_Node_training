...
import { addUser, addUserAction } from '../Slice/Slice';
        ...
        <div style={{ width: "25%", alignItems: "center", margin: "auto" }}>
            <form>
                <div className="mb-3">
                    ...
                    <input type="text" className="form-control" name="id" id="id" aria-describedby="emailHelp" onChange={(e)=>handleChange(e)} value={user.id} />
                </div>
                <div className="mb-3">
