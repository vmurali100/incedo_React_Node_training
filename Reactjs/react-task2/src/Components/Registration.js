...
<label for="name" className="form-label" style={{color:"#0A0A0A
...
<label for="exampleInputtext1" className="form-label" style={{color:"#0A0A0A
...
<label for="exampleInputtext1" className="form-label" name="lastname" style={{color:"#0A0A0A
